...
public class MemberApi {
    ...
    @ApiMapping(value = "comvita.member.info.get", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.member.current.get", method = RequestMethod.POST)
    public MemberInfo getCurrentMember() {
        return MdcUtil.getRequireCurrentMember();
    }

    @ApiOperation(value = "查询登录会员其它信息", notes = "查询登录会员其它信息")
    @ApiMapping(value = "comvita.member.other.get", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.member.extra.save", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.member.info.register", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.member.info.login", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.member.channelRel.add", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.member.file.upload", method = RequestMethod.POST)
