...
public class ExchangeApi {
    ...
    @ApiMapping(value = "mdc.exchange.catalog.list", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.exchange.goods.page", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.exchange.recommend.page", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.exchange.goods.get", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.exchange.goods.getSpecValue", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.exchange.goods.getSku", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.exchange.order.add", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.exchange.order.pay", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.exchange.order.page", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.exchange.order.get", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.exchange.goods.pageShopGood", method = RequestMethod.POST)
