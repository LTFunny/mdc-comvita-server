...
public class ParkingApi {
    ...
    @ApiMapping(value = "comvita.parking.unlicensedCar.in", method = RequestMethod.POST)
    public void scanIn(UnlicensedCarParam param) {
        parkingOrderService.scanIn(param);
    }

    @ApiOperation(value = "获取停车计费信息", notes = "获取停车计费信息")
    @ApiMapping(value = "comvita.parking.orderCharge.get", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.parking.orderCharge.batchGet", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.parking.order.add", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.parking.order.page", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.parking.order.get", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.parking.order.refund", method = RequestMethod.POST)
    public void refundOrder(OrderGetParam param) {
        parkingOrderService.refundOrder(param);
    }

    @ApiOperation(value = "新增电子发票", notes = "新增电子发票")
    @ApiMapping(value = "comvita.parking.invoice.add", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.parking.invoice.page", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.parking.invoice.get", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.parking.coupon.page", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.parking.coupon.get", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.parking.coupon.judge", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.parking.coupon.use", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.parking.car.save", method = RequestMethod.POST)
    public void saveCar(MemberCarParam param) {
        parkingMemberCarService.saveCar(param);
    }

    @ApiOperation(value = "删除车牌号", notes = "删除车牌号")
    @ApiMapping(value = "comvita.parking.car.delete", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.parking.car.list", method = RequestMethod.POST)
