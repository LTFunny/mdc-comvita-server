...
public class LotteryActivityApi {
    ...
    @ApiMapping(value = "mdc.lottery.info.page", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.lottery.info.get", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.lottery.record.list", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.lottery.record.add", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.lottery.record.page", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.lottery.memberRecord.page", method = RequestMethod.POST)
