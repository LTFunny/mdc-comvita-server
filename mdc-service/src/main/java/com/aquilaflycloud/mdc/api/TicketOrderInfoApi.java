...
public class TicketOrderInfoApi {
    ...
    @ApiMapping(value = "mdc.ticket.orderInfo.list", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.ticket.orderInfo.getCustInfo", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.ticket.orderInfo.create", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.ticket.orderInfo.pay", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.ticket.orderInfo.release", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.ticket.orderInfo.createAndPay", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.ticket.orderInfo.refund", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "mdc.ticket.orderInfo.getById", method = RequestMethod.POST)
