...
@Data
@TableName(value = "alipay_business_mall_trade_refund_info")
public class AlipayBusinessMallTradeRefundInfo {
    ...
    @TableField(value = "gmt_refund_pay")
    ...
    public AlipayBusinessMallTradeRefundInfo(String charset, String notifyTimestamp, String version, String signType, String notifyId, String appId, String sign) {
    ...
    public AlipayBusinessMallTradeRefundInfo() {
    }
}
