...
@Data
@TableName(value = "apply_member_record")
public class ApplyMemberRecord implements Serializable {
    /**
     * id
     */
    @TableId(value = "id")
     ...
     * 报名图片内容
     */
    @TableField(value = "apply_imgs")
    @ApiModelProperty(value = "报名图片内容")
