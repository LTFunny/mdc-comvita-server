...
@Data
public class GoodsCouponAddParam implements Serializable {
    ...
    private Date verificateStartTime = DateUtil.parseTime("00:00:00");

    @ApiModelProperty(value = "有效核销结束时间(HH:mm:ss)")
    @JSONField(format = "HH:mm:ss")
    private Date verificateEndTime = DateUtil.parseTime("23:59:59");
