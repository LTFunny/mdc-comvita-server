...
public class MemberScanController {
    ...
    @ApiMapping(value = "backend.comvita.member.ticket.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.member.ticket.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.member.ticket.audit", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.member.ticket.edit", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:memberTicket:page')")
    @ApiMapping(value = "backend.comvita.member.ticket.preNextInfo", method = RequestMethod.POST, permission = true)
