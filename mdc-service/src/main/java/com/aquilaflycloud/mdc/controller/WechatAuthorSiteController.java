...
public class WechatAuthorSiteController {
    ...
    @ApiMapping(value = "backend.mdc.wechat.author.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.wechat.preAuthUrl.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:authorSiteSave')")
    @ApiMapping(value = "backend.mdc.wechat.author.update", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:authorSiteSave')")
    @ApiMapping(value = "backend.mdc.wechat.templateList.load", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:authorSiteSave')")
    @ApiMapping(value = "backend.mdc.wechat.oauth2Url.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.wechat.jsapiSign.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:authorSiteSave')")
    @ApiMapping(value = "backend.mdc.wechat.qrCodeMsg.page", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:authorSiteSave')")
    @ApiMapping(value = "backend.mdc.wechat.qrCodeMsg.add", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:authorSiteSave')")
    @ApiMapping(value = "backend.mdc.wechat.qrCodeMsg.edit", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.wechat.userAnalysis.get", method = RequestMethod.POST, permission = true)
