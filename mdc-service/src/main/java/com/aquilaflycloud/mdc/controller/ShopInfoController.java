...
public class ShopInfoController {
    ...
    @ApiMapping(value = "backend.mdc.shop.info.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.shop.info.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.shop.info.edit", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:shop:info:page')")
    @ApiMapping(value = "backend.mdc.shop.info.getOperateInfo", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.shop.info.synchronization", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:shop:info:page')")
    @ApiMapping(value = "backend.mdc.shop.info.downloadShopCode", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:shop:info:get')")
    @ApiMapping(value = "backend.mdc.shop.info.download", method = RequestMethod.POST, permission = true)
