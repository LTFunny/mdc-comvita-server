...
public class WechatMiniProgramSubscribeMessageController {
    ...
    @ApiMapping(value = "backend.comvita.wechat.newTmplCategory.list", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:subscribeMessage')")
    @ApiMapping(value = "backend.comvita.wechat.pubTemplateTitle.page", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:subscribeMessage')")
    @ApiMapping(value = "backend.comvita.wechat.pubTemplateKeyword.list", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:subscribeMessage')")
    @ApiMapping(value = "backend.comvita.wechat.template.add", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:subscribeMessage')")
    @ApiMapping(value = "backend.comvita.wechat.template.list", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:subscribeMessage')")
    @ApiMapping(value = "backend.comvita.wechat.template.delete", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:subscribeMessage')")
    @ApiMapping(value = "backend.comvita.wechat.message.save", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:subscribeMessage')")
    @ApiMapping(value = "backend.comvita.wechat.message.edit", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:subscribeMessage')")
    @ApiMapping(value = "backend.comvita.wechat.message.toggle", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:subscribeMessage')")
    @ApiMapping(value = "backend.comvita.wechat.message.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:subscribeMessage')")
    @ApiMapping(value = "backend.comvita.wechat.message.list", method = RequestMethod.POST, permission = true)
