...
public class IsvAppInfoController {
    ...
    @ApiMapping(value = "backend.mdc.isv.info.list", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.isv.info.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.isv.info.save", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.isv.info.delete", method = RequestMethod.POST, permission = true)
