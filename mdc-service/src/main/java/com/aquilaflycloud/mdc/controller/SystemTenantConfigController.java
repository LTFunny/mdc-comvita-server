...
public class SystemTenantConfigController {
    ...
    @ApiMapping(value = "backend.mdc.system.config.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.system.config.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.system.config.add", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.system.config.edit", method = RequestMethod.POST, permission = true)
