...
public class CouponCatalogController {
    ...
    @ApiMapping(value = "backend.comvita.coupon.catalog.page", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:couponCatalog:list')")
    @ApiMapping(value = "backend.comvita.coupon.catalog.list", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.coupon.catalog.add", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.coupon.catalog.edit", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:couponCatalog:edit')")
    @ApiMapping(value = "backend.comvita.coupon.catalog.toggle", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.coupon.catalog.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.coupon.catalog.delete", method = RequestMethod.POST, permission = true)
