...
public class MemberChannelController {
    ...
    @ApiMapping(value = "backend.mdc.member.channel.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.member.channel.add", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:memberChannel:add')")
    @ApiMapping(value = "backend.mdc.member.channel.batchAdd", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.member.channel.edit", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:memberChannel:edit')")
    @ApiMapping(value = "backend.mdc.member.channel.toggle", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:memberChannel:list')")
    @ApiMapping(value = "backend.mdc.member.channelMiniCode.download", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:memberChannel:list')")
    @ApiMapping(value = "backend.mdc.member.channelStatistics.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:memberChannel:list')")
    @ApiMapping(value = "backend.mdc.member.channelAnalysis.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:memberChannel:list')")
    @ApiMapping(value = "backend.mdc.member.channelTop.List", method = RequestMethod.POST, permission = true)
