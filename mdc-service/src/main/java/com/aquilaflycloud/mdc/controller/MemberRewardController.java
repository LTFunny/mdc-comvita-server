...
public class MemberRewardController {
    ...
    @ApiMapping(value = "backend.mdc.reward.rule.list", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.reward.sign.save", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.reward.sign.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:reward:ruleSave')")
    @ApiMapping(value = "backend.mdc.reward.scan.save", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:reward:ruleGet')")
    @ApiMapping(value = "backend.mdc.reward.scan.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:reward:ruleSave')")
    @ApiMapping(value = "backend.mdc.reward.clean.save", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:reward:ruleGet')")
    @ApiMapping(value = "backend.mdc.reward.clean.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:reward:ruleSave')")
    @ApiMapping(value = "backend.mdc.reward.ruleState.toggle", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.reward.record.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.reward.record.add", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:reward:list')")
    @ApiMapping(value = "backend.mdc.reward.recordRank.list", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.reward.recordRank.init", method = RequestMethod.POST, permission = true)
