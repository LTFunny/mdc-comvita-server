...
public class ExchangeController {
    ...
    @ApiMapping(value = "backend.mdc.exchange.goods.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.exchange.goods.add", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.exchange.goods.edit", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:exchangeGoods:edit')")
    @ApiMapping(value = "backend.mdc.exchange.goods.toggle", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.exchange.goods.audit", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.exchange.goods.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:exchangeGoods:list')")
    @ApiMapping(value = "backend.mdc.exchange.goodsRank.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.exchange.orderStatistics.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:exchangeOrder:list')")
    @ApiMapping(value = "backend.mdc.exchange.orderAnalysis.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:exchangeOrder:list')")
    @ApiMapping(value = "backend.mdc.exchange.order.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.exchange.order.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.exchange.orderReceive.edit", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:exchangeOrder:edit')")
    @ApiMapping(value = "backend.mdc.exchange.order.edit", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.exchange.order.finish", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.exchange.order.refund", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:exchangeOrder:edit')")
    @ApiMapping(value = "backend.mdc.exchange.order.confirm", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:exchangeOrder:edit')")
    @ApiMapping(value = "backend.mdc.exchange.order.deliver", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:exchangeOrder:refund')")
    @ApiMapping(value = "backend.mdc.exchange.orderRefund.audit", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.exchange.order.enforceRefund", method = RequestMethod.POST, permission = true)
