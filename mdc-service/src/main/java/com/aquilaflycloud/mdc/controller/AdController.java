...
public class AdController {
    ...
    @ApiMapping(value = "backend.comvita.ad.info.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.ad.info.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.ad.info.delete", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.ad.info.add", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.ad.info.edit", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:ad:edit')")
    @ApiMapping(value = "backend.comvita.ad.state.toggle", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:ad:list')")
    @ApiMapping(value = "backend.comvita.ad.statistics.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.ad.info.audit", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.ad.eventStatistics.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:ad:eventGet')")
    @ApiMapping(value = "backend.comvita.ad.eventAnalysis.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:ad:eventGet')")
    @ApiMapping(value = "backend.comvita.ad.eventDistribution.get", method = RequestMethod.POST, permission = true)
