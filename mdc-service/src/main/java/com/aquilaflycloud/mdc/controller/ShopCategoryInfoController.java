...
public class ShopCategoryInfoController {
    ...
    @ApiMapping(value = "backend.comvita.shop.category.info.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.shop.category.info.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.shop.category.info.add", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.shop.category.info.edit", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.shop.category.info.delete", method = RequestMethod.POST, permission = true)
