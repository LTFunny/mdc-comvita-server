...
public class ShopCommentInfoController {
    ...
    @ApiMapping(value = "backend.comvita.shop.comment.info.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.shop.comment.info.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.shop.comment.info.audit", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.shop.comment.info.delete", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:shop:comment:info:page')")
    @ApiMapping(value = "backend.comvita.shop.comment.info.getStarRatingSort", method = RequestMethod.POST, permission = true)
