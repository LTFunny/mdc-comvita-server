...
public class TicketOrderInfoController {
    ...
    @ApiMapping(value = "backend.mdc.ticket.orderinfo.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiOperation("购票订单详情")
    @PreAuthorize("hasAuthority('mdc:ticket:orderinfo:page')")
    @ApiMapping(value = "backend.mdc.ticket.orderinfo.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.ticket.refund.list", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.ticket.refund.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.ticket.verificate.chart", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.ticket.verificate.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiOperation("核销概况")
    @PreAuthorize("hasAuthority('mdc:ticket:verificate:list')")
    @ApiMapping(value = "backend.mdc.ticket.verificate.statistics", method = RequestMethod.POST, permission = true)
    ...
    @ApiOperation("核销记录列表")
    @PreAuthorize("hasAuthority('mdc:ticket:verificate:list')")
    @ApiMapping(value = "backend.mdc.ticket.verificate.page", method = RequestMethod.POST, permission = true)
