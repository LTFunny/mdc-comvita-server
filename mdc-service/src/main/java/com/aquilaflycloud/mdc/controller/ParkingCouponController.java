...
public class ParkingCouponController {
    ...
    @ApiMapping(value = "backend.mdc.parking.couponRecord.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.parking.couponRecord.add", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:parkingCouponRecord:add')")
    @ApiMapping(value = "backend.mdc.parking.couponRecordInventory.add", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.parking.couponRecord.audit", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.parking.coupon.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.parking.coupon.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.parking.coupon.toggle", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:parkingCoupon:edit')")
    @ApiMapping(value = "backend.mdc.parking.coupon.edit", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.parking.coupon.delete", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.parking.couponMemberRel.add", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.parking.couponMemberRel.page", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:parkingCouponMemberRel:list')")
    @ApiMapping(value = "backend.mdc.parking.relStatistics.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:parkingCouponMemberRel:list')")
    @ApiMapping(value = "backend.mdc.parking.relDetailAnalysis.page", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:parkingCouponMemberRel:list')")
    @ApiMapping(value = "backend.mdc.parking.relSummaryAnalysis.page", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:parkingCouponMemberRel:list')")
    @ApiMapping(value = "backend.mdc.parking.relRecordAnalysis.page", method = RequestMethod.POST, permission = true)
