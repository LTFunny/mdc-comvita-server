...
public class WechatMiniProgramCodeController {
    ...
    @ApiMapping(value = "backend.mdc.wechat.code.page", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:codeList')")
    @ApiMapping(value = "backend.mdc.wechat.codeAccount.page", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:codeList')")
    @ApiMapping(value = "backend.mdc.wechat.miniDevCode.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:codeList')")
    @ApiMapping(value = "backend.mdc.wechat.miniAuditCode.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:codeList')")
    @ApiMapping(value = "backend.mdc.wechat.miniProdCode.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.mdc.wechat.code.commit", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:codeSave')")
    @ApiMapping(value = "backend.mdc.wechat.code.add", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:codeSave')")
    @ApiMapping(value = "backend.mdc.wechat.codeQrcode.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:codeSave')")
    @ApiMapping(value = "backend.mdc.wechat.codeCategory.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:codeSave')")
    @ApiMapping(value = "backend.mdc.wechat.codePage.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:codeSave')")
    @ApiMapping(value = "backend.mdc.wechat.code.submit", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:codeSave')")
    @ApiMapping(value = "backend.mdc.wechat.code.undo", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:codeSave')")
    @ApiMapping(value = "backend.mdc.wechat.codeAudit.update", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:codeSave')")
    @ApiMapping(value = "backend.mdc.wechat.code.release", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:codeSave')")
    @ApiMapping(value = "backend.mdc.wechat.code.revert", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:wechat:codeSave')")
    @ApiMapping(value = "backend.mdc.wechat.codeVisit.change", method = RequestMethod.POST, permission = true)
