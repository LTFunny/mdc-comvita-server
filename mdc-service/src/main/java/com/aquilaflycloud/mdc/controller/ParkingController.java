...
public class ParkingController {
    ...
    @ApiMapping(value = "backend.comvita.parking.ajbCloud.call", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:parking:manage')")
    @ApiMapping(value = "backend.comvita.parking.ajbCharge.page", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:parking:manage')")
    @ApiMapping(value = "backend.comvita.parking.ajbEnter.page", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:parking:manage')")
    @ApiMapping(value = "backend.comvita.parking.ajbLock.page", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:parking:manage')")
    @ApiMapping(value = "backend.comvita.parking.ajbLockErr.page", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:parking:manage')")
    @ApiMapping(value = "backend.comvita.parking.ajbCoupon.page", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:parking:manage')")
    @ApiMapping(value = "backend.comvita.parking.ajbInterface.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.parking.carNo.page", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:parkingCar:list')")
    @ApiMapping(value = "backend.comvita.parking.unlicensedCar.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.parking.orderCharge.get", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:parkingOrder:list')")
    @ApiMapping(value = "backend.comvita.parking.order.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.parking.order.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.parking.order.refund", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:parkingOrder:list')")
    @ApiMapping(value = "backend.comvita.parking.invoice.page", method = RequestMethod.POST, permission = true)
