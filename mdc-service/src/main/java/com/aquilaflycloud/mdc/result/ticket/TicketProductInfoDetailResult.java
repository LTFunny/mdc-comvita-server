...
@Data
public class TicketProductInfoDetailResult implements Serializable {

    private static final long serialVersionUID = -7572818558333212452L;

    @ApiModelProperty(value = "产品信息")
    private TicketProductInfo ticketProductInfo;

    @ApiModelProperty(value = "产品详情")
    private List<TicketProductInfoDetail> ticketProductInfoDetailList;

    public TicketProductInfoDetailResult(TicketProductInfo ticketProductInfo, List<TicketProductInfoDetail> ticketProductInfoDetailList) {
        this.ticketProductInfo = ticketProductInfo;
        this.ticketProductInfoDetailList = ticketProductInfoDetailList;
    }

    public TicketProductInfoDetailResult() {
    }
}
