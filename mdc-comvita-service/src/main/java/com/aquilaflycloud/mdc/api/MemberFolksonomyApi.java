...
public class MemberFolksonomyApi {
    ...
    @ApiMapping(value = "comvita.folksonomy.member.list", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.folksonomy.memberRel.add", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.folksonomy.memberRel.delete", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.folksonomy.memberRel.list", method = RequestMethod.POST)
