...
public class TinyMemberApi {
    ...
    @ApiMapping(value = "comvita.tiny.member.login", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.tiny.member.authorize", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.tiny.run.get", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.tiny.phone.get", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "comvita.tiny.phone.edit", method = RequestMethod.POST)
