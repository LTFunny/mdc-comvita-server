...
@Data
@TableName(value = "parking_coupon_order_record")
public class ParkingCouponOrderRecord implements Serializable {
    /**
     * id
     */
    @TableId(value = "id")
     ...
     * 库存增加值
     */
    @TableField(value = "inventory_increase")
    @ApiModelProperty(value = "库存增加值")
