...
@Data
@TableName(value = "mission_member_record")
public class MissionMemberRecord implements Serializable {
    /**
     * id
     */
    @TableId(value = "id")
     ...
     * 任务条件
     */
    @TableField(value = "mission_condition")
    @ApiModelProperty(value = "任务条件")
    private Integer missionCondition;
    ...
    private WhetherEnum finishState;
