...
@Data
@TableName(value = "exchange_order_operate_record")
public class ExchangeOrderOperateRecord implements Serializable {
    /**
     * id
     */
    @TableId(value = "id")
    ...
    private OrderStateEnum beforeState;
    ...
    private OrderStateEnum afterState;
