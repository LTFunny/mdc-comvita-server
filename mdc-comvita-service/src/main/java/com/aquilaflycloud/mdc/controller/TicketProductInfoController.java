...
public class TicketProductInfoController {
    ...
    @ApiMapping(value = "backend.comvita.ticket.productInfo.pull", method = RequestMethod.POST, permission = true)
    public void pullProductInfo() {
        ticketProductInfoService.getInterfaceProductInfo();
    }

    @ApiOperation("任务同步产品信息")
    @ApiMapping(value = "backend.comvita.ticket.productInfo.normalPull", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "backend.comvita.ticket.productInfo.page", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:ticket:productInfo:page')")
    @ApiMapping(value = "backend.comvita.ticket.productInfo.activityList", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "backend.comvita.ticket.productInfo.updateRecommend", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:ticket:productInfo:save')")
    @ApiMapping(value = "backend.comvita.ticket.productInfo.updateTop", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:ticket:productInfo:save')")
    @ApiMapping(value = "backend.comvita.ticket.productInfo.updatePlayTime", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:ticket:productInfo:save')")
    @ApiMapping(value = "backend.comvita.ticket.productInfo.updateComposite", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:ticket:productInfo:save')")
    @ApiMapping(value = "backend.comvita.ticket.productInfo.updateUpper", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:ticket:productInfo:save')")
    @ApiMapping(value = "backend.comvita.ticket.productInfo.updateIntroduce", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.ticket.productInfo.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.ticket.productInfo.getproduct", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "backend.comvita.ticket.productInfo.sales", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:ticket:productInfo:sales')")
    @ApiMapping(value = "backend.comvita.ticket.productInfo.salesOrder", method = RequestMethod.POST, permission = true)
