...
public class PreOrderReportController {
    ...
    @ApiMapping(value = "backend.comvita.order.report.page", method = RequestMethod.POST)
    ...
    @ApiMapping(value = "backend.comvita.achievements.guide", method = RequestMethod.POST)
