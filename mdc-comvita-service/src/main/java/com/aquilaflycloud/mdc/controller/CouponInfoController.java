...
public class CouponInfoController {
    ...
    @ApiMapping(value = "backend.comvita.coupon.info.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.coupon.info.add", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.coupon.info.edit", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.coupon.info.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.coupon.info.audit", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:coupon:list')")
    @ApiMapping(value = "backend.comvita.coupon.statistics.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.coupon.rel.page", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.coupon.rel.get", method = RequestMethod.POST, permission = true)
    ...
    @ApiMapping(value = "backend.comvita.coupon.rel.use", method = RequestMethod.POST, permission = true)
    ...
    @PreAuthorize("hasAuthority('mdc:couponRel:list')")
    @ApiMapping(value = "backend.comvita.coupon.relAnalysis.get", method = RequestMethod.POST, permission = true)
